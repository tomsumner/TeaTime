...
/* Version 9 - converted to single year age bins and aging done via events- this ensures individuals remain in the correct age cohorts */
...
/* CURRENTLY ATTEMPTING TO DO ART BY AGE - i.e. TO CAPTURE DIFFERENT COVERAGE IN CHILDREN */
...
/* Add in ART coverage for children */
#define Ahigh_child forc[282] /* ART coverage by CD4 - depends on overall coverage and eligibility threshold (threshold is assummed same by age but coverage differs) */
#define A500_child forc[283]
#define A349_child forc[284]
#define A249_child forc[285]
#define A199_child forc[286]
#define A99_child forc[287]
#define A50_child forc[288]
      ...
      TB_cases_age[i] = TB_cases_age[i] + TB_cases_neg_age[i];
        ...
        for (j=0; j<n_HIV; j++){      /* CD4 */
          ...
          dS_H[i][j] = - m_b[i]*S_H[i][j] - 
                      ...
                      up_H_mort[j][i]*S_H[i][j] - ART_prop[i][j]*S_H[i][j] + (S_H[i][j]/tot_age[i])*(forc[i+188]/5);
          ...
          dLsn_H[i][j] = - m_b[i]*Lsn_H[i][j] +
                        ...
                        up_H_mort[j][i]*Lsn_H[i][j] - ART_prop[i][j]*Lsn_H[i][j] + (Lsn_H[i][j]/tot_age[i])*(forc[i+188]/5)-
          ...
          dLsp_H[i][j] = - m_b[i]*Lsp_H[i][j] +
                        ...
                        up_H_mort[j][i]*Lsp_H[i][j] - ART_prop[i][j]*Lsp_H[i][j] + (Lsp_H[i][j]/tot_age[i])*(forc[i+188]/5)-
          ...
          dLmn_H[i][j] = - m_b[i]*Lmn_H[i][j] +
                        ...
                        up_H_mort[j][i]*Lmn_H[i][j] - ART_prop[i][j]*Lmn_H[i][j] + (Lmn_H[i][j]/tot_age[i])*(forc[i+188]/5) + PTnH_to_LmnH;
          ...
          dLmp_H[i][j] = - m_b[i]*Lmp_H[i][j] + 
                        ...
                        up_H_mort[j][i]*Lmp_H[i][j] - ART_prop[i][j]*Lmp_H[i][j] + (Lmp_H[i][j]/tot_age[i])*(forc[i+188]/5) + PTpH_to_LmpH;
          ...
          dNsn_H[i][j] = - m_b[i]*Nsn_H[i][j] +
                        ...
                        up_H_mort[j][i]*Nsn_H[i][j] - ART_prop[i][j]*Nsn_H[i][j] + (Nsn_H[i][j]/tot_age[i])*(forc[i+188]/5) + PTnH_to_NsnH;
          ...
          dNsp_H[i][j] = - m_b[i]*Nsp_H[i][j] + 
                        ...
                        up_H_mort[j][i]*Nsp_H[i][j] - ART_prop[i][j]*Nsp_H[i][j] + (Nsp_H[i][j]/tot_age[i])*(forc[i+188]/5) + PTpH_to_NspH;
          ...
          dNmn_H[i][j] = - m_b[i]*Nmn_H[i][j] +
                        ...
                        up_H_mort[j][i]*Nmn_H[i][j] - ART_prop[i][j]*Nmn_H[i][j] + (Nmn_H[i][j]/tot_age[i])*(forc[i+188]/5) + PTnH_to_NmnH;
          ...
          dNmp_H[i][j] = - m_b[i]*Nmp_H[i][j] +
                        ...
                        up_H_mort[j][i]*Nmp_H[i][j] - ART_prop[i][j]*Nmp_H[i][j] + (Nmp_H[i][j]/tot_age[i])*(forc[i+188]/5) + PTpH_to_NmpH;
          ...
          dIsn_H[i][j] = - m_b[i]*Isn_H[i][j] +
                        ...
                        up_H_mort[j][i]*Isn_H[i][j] - ART_prop[i][j]*Isn_H[i][j] + (Isn_H[i][j]/tot_age[i])*(forc[i+188]/5) + PTnH_to_IsnH;
          ...
          dIsp_H[i][j] = - m_b[i]*Isp_H[i][j] +
                        ...
                        up_H_mort[j][i]*Isp_H[i][j] - ART_prop[i][j]*Isp_H[i][j] + (Isp_H[i][j]/tot_age[i])*(forc[i+188]/5) + PTpH_to_IspH;       
          ...
          dImn_H[i][j] = - m_b[i]*Imn_H[i][j] +
                        ...
                        up_H_mort[j][i]*Imn_H[i][j] - ART_prop[i][j]*Imn_H[i][j] + (Imn_H[i][j]/tot_age[i])*(forc[i+188]/5) + PTnH_to_ImnH;
          ...
          dImp_H[i][j] = - m_b[i]*Imp_H[i][j] +
                        ...
                        up_H_mort[j][i]*Imp_H[i][j] - ART_prop[i][j]*Imp_H[i][j] + (Imp_H[i][j]/tot_age[i])*(forc[i+188]/5) + PTpH_to_ImpH;       
          ...
          dPTn_H[i][j] = -m_b[i]*PTn_H[i][j] - PTnH_to_LsnH - PTnH_to_NsnH - PTnH_to_IsnH - PTnH_to_LmnH - PTnH_to_NmnH - PTnH_to_ImnH +
                         ...
                         up_H_mort[j][i]*PTn_H[i][j] - ART_prop[i][j]*PTn_H[i][j] + (PTn_H[i][j]/tot_age[i])*(forc[i+188]/5);
          ...
          dPTp_H[i][j] = - m_b[i]*PTp_H[i][j] - PTpH_to_LspH - PTpH_to_NspH - PTpH_to_IspH - PTpH_to_LmpH - PTpH_to_NmpH - PTpH_to_ImpH +
                         ...
                         up_H_mort[j][i]*PTp_H[i][j] - ART_prop[i][j]*PTp_H[i][j] + (PTp_H[i][j]/tot_age[i])*(forc[i+188]/5);
