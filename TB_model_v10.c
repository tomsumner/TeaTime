...
/* CURRENTLY ATTEMPTING TO DO ART BY AGE - TIME TAKES AGE (AND GENDER) SPECIFIC ART COVERAGE FROM AIM */
...
#define BCG_cov forc[163] /* BCG coverage */

#define pop_ad forc[164]  /* used to turn on/off adjustment of population to account for disease induced mortality - idea is to turn it off from 2015 onwards*/

#define kneg forc[165]  /* detection rate */
#define kpos forc[166]

#define rel_d forc[167] /* relative detection of smear negatives */

#define dstneg_n forc[168]   /* dst coverage in new cases */
#define dstneg_p forc[169]   /* dst coverage in previoulsy treated cases */
#define dstpos_n forc[170]  
#define dstpos_p forc[171] 

#define l_s forc[172]  /* linkage to care */
#define l_m forc[173]

#define tneg_s forc[174]  /* treatment success */
#define tpos_s forc[175]
#define tART_s forc[176]
#define tneg_m forc[177]
#define tpos_m forc[178]
#define tART_m forc[179]

#define mig0 forc[180]  /* migration by age x */
#define mig1 forc[181]
#define mig2 forc[182]
#define mig3 forc[183]
#define mig4 forc[184]
#define mig5 forc[185]
#define mig6 forc[186]
#define mig7 forc[187]
#define mig8 forc[188]
#define mig9 forc[189]
#define mig10 forc[190]
#define mig11 forc[191]
#define mig12 forc[192]
#define mig13 forc[193]
#define mig14 forc[194]
#define mig15 forc[195]
#define mig16 forc[196]
#define mig17 forc[197]
#define mig18 forc[198]       
#define mig19 forc[199] 
#define mig20 forc[200] 
#define mig21 forc[201] 
#define mig22 forc[202]
#define mig23 forc[203]
#define mig24 forc[204]
#define mig25 forc[205]
#define mig26 forc[206]
#define mig27 forc[207]
#define mig28 forc[208]
#define mig29 forc[209]
#define mig30 forc[210]
#define mig31 forc[211]
#define mig32 forc[212]
#define mig33 forc[213]
#define mig34 forc[214]
#define mig35 forc[215]
#define mig36 forc[216]
#define mig37 forc[217]
#define mig38 forc[218]         
#define mig39 forc[219] 
#define mig40 forc[220] 
#define mig41 forc[221] 
#define mig42 forc[222]
#define mig43 forc[223]
#define mig44 forc[224]
#define mig45 forc[225]
#define mig46 forc[226]
#define mig47 forc[227]
#define mig48 forc[228]
#define mig49 forc[229]
#define mig50 forc[230]
#define mig51 forc[231]
#define mig52 forc[232]
#define mig53 forc[233]
#define mig54 forc[234]
#define mig55 forc[235]
#define mig56 forc[236]
#define mig57 forc[237]
#define mig58 forc[238]        
#define mig59 forc[239] 
#define mig60 forc[240] 
#define mig61 forc[241] 
#define mig62 forc[242]
#define mig63 forc[243]
#define mig64 forc[244]
#define mig65 forc[245]
#define mig66 forc[246]
#define mig67 forc[247]
#define mig68 forc[248]
#define mig69 forc[249]
#define mig70 forc[250]
#define mig71 forc[251] 
#define mig72 forc[252]
#define mig73 forc[253]
#define mig74 forc[254]
#define mig75 forc[255]
#define mig76 forc[256]
#define mig77 forc[257]
#define mig78 forc[258]
#define mig79 forc[259]
#define mig80 forc[260]

/* sens and spec for tests */
#define se_I_neg forc[261]
#define se_N_neg forc[262]
#define se_m_neg forc[263]

#define sp_I_neg forc[264]
#define sp_N_neg forc[265]
#define sp_m_neg forc[266]

#define se_I_pos forc[267]
#define se_N_pos forc[268]
#define se_m_pos forc[269]

#define sp_I_pos forc[270]
#define sp_N_pos forc[271]
#define sp_m_pos forc[272]

/* RR for presentation for healthy individuals */
#define health forc[273]
...
#define Athresh forc[355] /* ART eligibility threshold (CD4 category) */
...
void derivsc(int *neq, double *t, double *y, double *ydot, double *yout, int *ip)
{
    ...
    for (i=0; i<n_age; i++){
      ...
      for (j=0; j<n_HIV; j++){
        ...
        if (j>=Athresh) { /* If this CD4 is eligible for ART */
          ART_on[i] = ART_on[i] + (CD4_dist[i][j] + CD4_dist_ART[i][j])*forc[i+274]; /* number who should be on ART - HIV+ population times coverage (by CD4) */
        }
    ...
    for (i=0; i<n_age; i++){
      ...
      dS[i] = - (FS + FM)*S[i] - forc[i+82]*S[i] - m_b[i]*S[i] + (S[i]/tot_age[i])*(forc[i+180]/5);
       
      /* Latent, ds, naive */
      dLsn[i] = - m_b[i]*Lsn[i] + S_to_Lsn + Lmn_to_Lsn + r*(Isn[i] + Nsn[i]) - Lsn_to_Lmn - Lsn_to_Nsn - Lsn_to_Isn  - Lsn_to_Nmn - Lsn_to_Imn -
                forc[i+82]*Lsn[i] + (Lsn[i]/tot_age[i])*(forc[i+180]/5) + PTn_to_Lsn -
      ...
      dLsp[i] = - m_b[i]*Lsp[i] + Lmp_to_Lsp + r*(Isp[i] + Nsp[i]) - Lsp_to_Lmp - Lsp_to_Nsp - Lsp_to_Isp  - Lsp_to_Nmp - Lsp_to_Imp +     
                ...
                forc[i+82]*Lsp[i] + (Lsp[i]/tot_age[i])*(forc[i+180]/5) + PTp_to_Lsp -
      ...
      dLmn[i] = - m_b[i]*Lmn[i] + S_to_Lmn + Lsn_to_Lmn + r*(Imn[i] + Nmn[i]) - Lmn_to_Lsn - Lmn_to_Nsn - Lmn_to_Isn - Lmn_to_Nmn - Lmn_to_Imn  -                
                forc[i+82]*Lmn[i] + (Lmn[i]/tot_age[i])*(forc[i+180]/5) + PTn_to_Lmn;              
      ...
      dLmp[i] = - m_b[i]*Lmp[i] + Lsp_to_Lmp + r*(Imp[i] + Nmp[i]) - Lmp_to_Lsp - Lmp_to_Nsp - Lmp_to_Isp - Lmp_to_Nmp - Lmp_to_Imp +
                ...
                forc[i+82]*Lmp[i] + (Lmp[i]/tot_age[i])*(forc[i+180]/5) + PTp_to_Lmp;  
      ...
      dNsn[i] = - m_b[i]*Nsn[i] + S_to_Nsn + Lsn_to_Nsn + Lmn_to_Nsn - (theta + r + muN_age[i])*Nsn[i] -
                ...
                forc[i+82]*Nsn[i] + (Nsn[i]/tot_age[i])*(forc[i+180]/5) + PTn_to_Nsn;  
      ...
      dNsp[i] = - m_b[i]*Nsp[i] + Lsp_to_Nsp + Lmp_to_Nsp - (theta + r + muN_age[i])*Nsp[i] -
                ...
                forc[i+82]*Nsp[i] + (Nsp[i]/tot_age[i])*(forc[i+180]/5) + PTp_to_Nsp;  
      ...
      dNmn[i] = - m_b[i]*Nmn[i] + S_to_Nmn + Lsn_to_Nmn + Lmn_to_Nmn - (theta + r + muN_age[i])*Nmn[i] -
                ...
                forc[i+82]*Nmn[i] + (Nmn[i]/tot_age[i])*(forc[i+180]/5) + PTn_to_Nmn;   
      ...
      dNmp[i] = - m_b[i]*Nmp[i] + Lsp_to_Nmp + Lmp_to_Nmp - (theta + r + muN_age[i])*Nmp[i] -
                ...
                forc[i+82]*Nmp[i] + (Nmp[i]/tot_age[i])*(forc[i+180]/5) + PTp_to_Nmp;  
      ...
      dIsn[i] = - m_b[i]*Isn[i] + S_to_Isn + Lsn_to_Isn + Lmn_to_Isn + theta*Nsn[i] - (r + muI_age[i])*Isn[i] - 
                ...
                forc[i+82]*Isn[i] + (Isn[i]/tot_age[i])*(forc[i+180]/5) + PTn_to_Isn;  
      ...
      dIsp[i] = - m_b[i]*Isp[i] + Lsp_to_Isp + Lmp_to_Isp + theta*Nsp[i] - (r + muI_age[i])*Isp[i] -   
                ...
                forc[i+82]*Isp[i] + (Isp[i]/tot_age[i])*(forc[i+180]/5) + PTp_to_Isp; 
      ...
      dImn[i] = - m_b[i]*Imn[i] + S_to_Imn + Lsn_to_Imn + Lmn_to_Imn + theta*Nmn[i] - (r + muI_age[i])*Imn[i] -
                ...
                forc[i+82]*Imn[i] + (Imn[i]/tot_age[i])*(forc[i+180]/5) + PTn_to_Imn;  
      ...
      TB_cases_age[i] = TB_cases_age[i] + TB_cases_neg_age[i];
        ...
        for (j=0; j<n_HIV; j++){      /* CD4 */
          ...
          dS_H[i][j] = - m_b[i]*S_H[i][j] - 
                      ...
                      up_H_mort[j][i]*S_H[i][j] - ART_prop[i][j]*S_H[i][j] + (S_H[i][j]/tot_age[i])*(forc[i+180]/5);
          ...
          dLsn_H[i][j] = - m_b[i]*Lsn_H[i][j] +
                        ...
                        up_H_mort[j][i]*Lsn_H[i][j] - ART_prop[i][j]*Lsn_H[i][j] + (Lsn_H[i][j]/tot_age[i])*(forc[i+180]/5)-
          ...
          dLsp_H[i][j] = - m_b[i]*Lsp_H[i][j] +
                        ...
                        up_H_mort[j][i]*Lsp_H[i][j] - ART_prop[i][j]*Lsp_H[i][j] + (Lsp_H[i][j]/tot_age[i])*(forc[i+180]/5)-
          ...
          dLmn_H[i][j] = - m_b[i]*Lmn_H[i][j] +
                        ...
                        up_H_mort[j][i]*Lmn_H[i][j] - ART_prop[i][j]*Lmn_H[i][j] + (Lmn_H[i][j]/tot_age[i])*(forc[i+180]/5) + PTnH_to_LmnH;
          ...
          dLmp_H[i][j] = - m_b[i]*Lmp_H[i][j] + 
                        ...
                        up_H_mort[j][i]*Lmp_H[i][j] - ART_prop[i][j]*Lmp_H[i][j] + (Lmp_H[i][j]/tot_age[i])*(forc[i+180]/5) + PTpH_to_LmpH;
          ...
          dNsn_H[i][j] = - m_b[i]*Nsn_H[i][j] +
                        ...
                        up_H_mort[j][i]*Nsn_H[i][j] - ART_prop[i][j]*Nsn_H[i][j] + (Nsn_H[i][j]/tot_age[i])*(forc[i+180]/5) + PTnH_to_NsnH;
          ...
          dNsp_H[i][j] = - m_b[i]*Nsp_H[i][j] + 
                        ...
                        up_H_mort[j][i]*Nsp_H[i][j] - ART_prop[i][j]*Nsp_H[i][j] + (Nsp_H[i][j]/tot_age[i])*(forc[i+180]/5) + PTpH_to_NspH;
          ...
          dNmn_H[i][j] = - m_b[i]*Nmn_H[i][j] +
                        ...
                        up_H_mort[j][i]*Nmn_H[i][j] - ART_prop[i][j]*Nmn_H[i][j] + (Nmn_H[i][j]/tot_age[i])*(forc[i+180]/5) + PTnH_to_NmnH;
          ...
          dNmp_H[i][j] = - m_b[i]*Nmp_H[i][j] +
                        ...
                        up_H_mort[j][i]*Nmp_H[i][j] - ART_prop[i][j]*Nmp_H[i][j] + (Nmp_H[i][j]/tot_age[i])*(forc[i+180]/5) + PTpH_to_NmpH;
          ...
          dIsn_H[i][j] = - m_b[i]*Isn_H[i][j] +
                        ...
                        up_H_mort[j][i]*Isn_H[i][j] - ART_prop[i][j]*Isn_H[i][j] + (Isn_H[i][j]/tot_age[i])*(forc[i+180]/5) + PTnH_to_IsnH;
          ...
          dIsp_H[i][j] = - m_b[i]*Isp_H[i][j] +
                        ...
                        up_H_mort[j][i]*Isp_H[i][j] - ART_prop[i][j]*Isp_H[i][j] + (Isp_H[i][j]/tot_age[i])*(forc[i+180]/5) + PTpH_to_IspH;       
          ...
          dImn_H[i][j] = - m_b[i]*Imn_H[i][j] +
                        ...
                        up_H_mort[j][i]*Imn_H[i][j] - ART_prop[i][j]*Imn_H[i][j] + (Imn_H[i][j]/tot_age[i])*(forc[i+180]/5) + PTnH_to_ImnH;
          ...
          dImp_H[i][j] = - m_b[i]*Imp_H[i][j] +
                        ...
                        up_H_mort[j][i]*Imp_H[i][j] - ART_prop[i][j]*Imp_H[i][j] + (Imp_H[i][j]/tot_age[i])*(forc[i+180]/5) + PTpH_to_ImpH;       
          ...
          dPTn_H[i][j] = -m_b[i]*PTn_H[i][j] - PTnH_to_LsnH - PTnH_to_NsnH - PTnH_to_IsnH - PTnH_to_LmnH - PTnH_to_NmnH - PTnH_to_ImnH +
                         ...
                         up_H_mort[j][i]*PTn_H[i][j] - ART_prop[i][j]*PTn_H[i][j] + (PTn_H[i][j]/tot_age[i])*(forc[i+180]/5);
          ...
          dPTp_H[i][j] = - m_b[i]*PTp_H[i][j] - PTpH_to_LspH - PTpH_to_NspH - PTpH_to_IspH - PTpH_to_LmpH - PTpH_to_NmpH - PTpH_to_ImpH +
                         ...
                         up_H_mort[j][i]*PTp_H[i][j] - ART_prop[i][j]*PTp_H[i][j] + (PTp_H[i][j]/tot_age[i])*(forc[i+180]/5);
       ...
       /* HIV+ on ART: loop through time on ART, CD4 at initiation, age */
          for (l=0; l<n_ART; l++){
            ...
            dS_A[i][j][l] = - m_b[i]*S_A[i][j][l] - (FS + FM)*S_A[i][j][l] +
                            ...
                            (S_A[i][j][l]/tot_age[i])*(forc[i+180]/5);
            ...
            dLsn_A[i][j][l] = - m_b[i]*Lsn_A[i][j][l] +
                            ...
                            (Lsn_A[i][j][l]/tot_age[i])*(forc[i+180]/5);
            ...
            dLsp_A[i][j][l] = - m_b[i]*Lsp_A[i][j][l] +
                            ...
                            (Lsp_A[i][j][l]/tot_age[i])*(forc[i+180]/5);
            ...
            dLmn_A[i][j][l] = - m_b[i]*Lmn_A[i][j][l] +
                            ...
                            (Lmn_A[i][j][l]/tot_age[i])*(forc[i+180]/5);
            ...
            dLmp_A[i][j][l] = - m_b[i]*Lmp_A[i][j][l] + 
                            ...
                            (Lmp_A[i][j][l]/tot_age[i])*(forc[i+180]/5);
            ...
            dNsn_A[i][j][l] = - m_b[i]*Nsn_A[i][j][l]+
                            ...
                            (Nsn_A[i][j][l]/tot_age[i])*(forc[i+180]/5);
            ...
            dNsp_A[i][j][l] = - m_b[i]*Nsp_A[i][j][l] + 
                            ...
                            (Nsp_A[i][j][l]/tot_age[i])*(forc[i+180]/5);
            ...
            dNmn_A[i][j][l] = - m_b[i]*Nmn_A[i][j][l] +
                            ...
                            (Nmn_A[i][j][l]/tot_age[i])*(forc[i+180]/5);
            ...
            dNmp_A[i][j][l] = - m_b[i]*Nmp_A[i][j][l] +
                            ...
                            (Nmp_A[i][j][l]/tot_age[i])*(forc[i+180]/5);
            ...
            dIsn_A[i][j][l] = - m_b[i]*Isn_A[i][j][l] +
                            ...
                            (Isn_A[i][j][l]/tot_age[i])*(forc[i+180]/5);
            ...
            dIsp_A[i][j][l] = - m_b[i]*Isp_A[i][j][l] +
                            ...
                            (Isp_A[i][j][l]/tot_age[i])*(forc[i+180]/5);
            ...
            dImn_A[i][j][l] = - m_b[i]*Imn_A[i][j][l] +
                            ...
                            (Imn_A[i][j][l]/tot_age[i])*(forc[i+180]/5);
            ...
            dImp_A[i][j][l] = - m_b[i]*Imp_A[i][j][l] +
                            ...
                            (Imp_A[i][j][l]/tot_age[i])*(forc[i+180]/5);             
